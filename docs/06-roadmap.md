...
## Phase 3 — Своя админка (~4–6 вечеров) — ✅ код готов 2026-07-30
...
**Готово, когда:** весь цикл от логина до публикации в своём UI ✅ — проверено локально: вход, создание, обложка (PNG→WebP), предпросмотр черновика, публикация, удаление, выход; 21 тест api зелёный.
